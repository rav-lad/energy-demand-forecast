...
class EntsoeConnector:
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                if response.status_code == 429:  # Rate limit
                    ...
                    raise ValueError("Invalid API key. Check your ENTSOE_API_KEY.") from e
    ...
    def get_actual_load(
        ...
        try:
            ...
            logger.info(f"Successfully fetched {len(df)} hourly load values for {country}")
            return df
...
def main():
    ...
    if not api_key:
        print("❌ ENTSO-E API key not found.")
    ...
    try:
        ...
        print("\n🔄 Downloading French market data (Jan 2022)...")
        ...
        print(f"\n✅ Successfully downloaded {len(data)} hourly records")
        print("\nSample data:")
        print(data.head(10))
